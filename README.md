...
<img src="public/logo.png" alt="Switch Fiber logo" width="140" height="140">
...
3. **Configure Environment Variables**:
   ...
   cp .env.example .env
   ```
   Edit `.env` and set `BACKEND_API_URL` to the upstream records API. `RESEND_API_KEY` (email) and `SEMAPHORE_API_KEY` (SMS) are optional; leave them unset to disable notifications while developing.
